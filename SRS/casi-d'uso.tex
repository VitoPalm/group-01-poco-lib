%===============================================
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:02]{FLR-02}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:03]{FLR-03}, \hyperref[FDR:02]{FDR-02}, \hyperref[FDR:03]{FDR-03}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
