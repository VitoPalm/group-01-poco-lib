%===============================================
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FBR:02]{FBR-02}, \hyperref[FDR:01]{FDR-01}, \hyperref[FIR:01.2.3]{FIR-01.2.3}, \hyperref[FIR:04]{FIR-04}, \hyperref[FIR:05]{FIR-05}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FBR:03]{FBR-03}, \hyperref[FIR:01.2.3]{FIR-01.2.3}, \hyperref[FIR:04]{FIR-04}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FBR:05]{FBR-05}, \hyperref[FBR:05.1]{FBR-05.1}, \hyperref[FIR:01.2]{FIR-01.2}, \hyperref[FIR:01.2.1]{FIR-01.2.1}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FUR:02]{FUR-02}, \hyperref[FDR:02]{FDR-02}, \hyperref[FIR:01.3.3]{FIR-01.3.3}, \hyperref[FIR:06]{FIR-06}, \hyperref[FIR:07]{FIR-07}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FUR:03]{FUR-03}, \hyperref[FIR:01.3.3]{FIR-01.3.3}, \hyperref[FIR:06]{FIR-06}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Postcondizioni}: Vengono mostrati i risultati corrispondenti.
        \item \textbf{Requisiti Implementati}: \hyperref[FUR:05]{FUR-05}, \hyperref[FUR:05.1]{FUR-05.1}, \hyperref[FIR:01.3]{FIR-01.3}, \hyperref[FIR:01.3.1]{FIR-01.3.1}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
            \item Il bibliotecario clicca sulla barra di ricerca.
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:01]{FLR-01}, \hyperref[FDR:03]{FDR-03}, \hyperref[FIR:01.2.3]{FIR-01.2.3}, \hyperref[FIR:01.3.3]{FIR-01.3.3}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:02]{FLR-02}, \hyperref[FDR:03]{FDR-03}, \hyperref[FIR:01.1.3]{FIR-01.1.3}, \hyperref[FIR:02]{FIR-02}, \hyperref[FIR:03]{FIR-03}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:03]{FLR-03}, \hyperref[FIR:01.1.3]{FIR-01.1.3}, \hyperref[FIR:02]{FIR-02}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Postcondizioni}: Vengono mostrati i risultati corrispondenti.
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:05]{FLR-05}, \hyperref[FLR:05.1]{FLR-05.1}, \hyperref[FIR:01.1]{FIR-01.1}, \hyperref[FIR:01.1.1]{FIR-01.1.1}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
            \item Il bibliotecario clicca sulla barra di ricerca.
...
del libro e/o Nome/Cognome/ID utente).
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:06]{FLR-06}, \hyperref[FDR:02]{FDR-02}, \hyperref[FDR:03]{FDR-03}, \hyperref[FIR:01.1.3]{FIR-01.1.3}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
