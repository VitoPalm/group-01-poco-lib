...
\subsubsection{Gestione dei prestiti (FLR)}\label{subsubsec:loan-management}
    ...
    \begin{table}[H]
        ...
        \begin{tabularx}{\textwidth}{|l|c|c|X|}
            ...
            \hline
            FLR-04\label{FLR:04} & ALTA & ALTO & \textbf{Elenco Prestiti Attivi:} Deve essere possibile visualizzare l'elenco dei prestiti attivi, ordinato per data prevista di restituzione, evidenziando quelli in ritardo \\
            \hline
