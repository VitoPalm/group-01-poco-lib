...
\subsubsection{Requisiti sull'interfaccia (FIR)}\label{subsubsec:interface-req}
    ...
    \begin{table}[H]
        ...
        \begin{tabularx}{\textwidth}{|l|c|c|X|}
            ...
            \hline
            FIR-01.1\label{FIR:01.1} & ALTA & BASSO & \textbf{Accesso Gestione Libri:} Dalla pagina principale deve essere possibile accedere alla sezione di gestione dei libri tramite una tab dedicata\\
            \hline
            ...
            \hline
            FIR-01.1.3\label{FIR:01.1.3} & ALTA & BASSO & \textbf{Area di Controllo:} Deve essere presente un'area che permetta di
            \hline
            FIR-01.2\label{FIR:01.2} & ALTA & BASSO & \textbf{Accesso Gestione Utenti:} Dalla pagina principale deve essere possibile accedere alla sezione di gestione degli utenti tramite una tab dedicata\\
            \hline
            FIR-01.3\label{FIR:01.3} & ALTA & BASSO & \textbf{Accesso Gestione Prestiti:} Dalla pagina principale deve essere possibile accedere alla sezione di gestione dei prestiti tramite una tab dedicata\\
            \hline
        \end{tabularx}
