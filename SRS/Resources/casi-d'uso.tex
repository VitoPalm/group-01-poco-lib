%===============================================
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FBR:01]{FBR-01}, \hyperref[FDR:01]{FDR-01}, \hyperref[FIR:01.2.3]{FIR-01.2.3}, \hyperref[FIR:05]{FIR-05}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
            \item Il bibliotecario clicca il bottone per aggiungere un libro.
            \item Il bibliotecario inserisce: titolo, autori, anno, \hyperref[subsubsec:terminology]{ISBN} e numero copie: il sistema valida l'\hyperref[subsubsec:terminology]{ISBN} (se implementato: \hyperref[NRR:03]{NRR-03}).
            \item Il bibliotecario clicca il bottone per salvare.
            \item Il sistema aggiunge il libro all'archivio.
        \end{enumerate}
        \item \textbf{Scenari Alternativi}:
        \begin{itemize}
            \item[3a.] Il sistema mostra un messaggio di errore se l'\hyperref[subsubsec:terminology]{ISBN} non è valido (se implementato: \hyperref[NUR:02]{NUR-02}).
        \end{itemize}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FBR:02]{FBR-02}, \hyperref[FDR:01]{FDR-01}, \hyperref[FIR:01.2.2]{FIR-01.2.2}, \hyperref[FIR:01.2.3]{FIR-01.2.3}, \hyperref[FIR:04]{FIR-04}, \hyperref[FIR:05]{FIR-05}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
        ...
        \item \textbf{Scenari Alternativi}:
        \begin{itemize}
            \item[5a.] Il sistema mostra un messaggio di errore se l'\hyperref[subsubsec:terminology]{ISBN} non è valido (se implementato: \hyperref[NUR:02]{NUR-02}).
        \end{itemize}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FBR:03]{FBR-03}, \hyperref[FIR:01.2.2]{FIR-01.2.2}, \hyperref[FIR:01.2.3]{FIR-01.2.3}, \hyperref[FIR:04]{FIR-04}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FBR:04]{FBR-04}, \hyperref[FBR:04.1]{FBR-04.1}, \hyperref[FIR:01.2]{FIR-01.2}, \hyperref[FIR:01.2.2]{FIR-01.2.2}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
        ...
        \item \textbf{Scenari Alternativi}:
        \begin{enumerate}
            \item[2a.] Il bibliotecario può richiedere l'ordinamento per Autore, Anno, \hyperref[subsubsec:terminology]{ISBN} o Numero di Copie, premendo l'header della colonna corrispondente alla proprietà, e ri-premendo per invertire l'ordinamento rispetto alla stessa proprietà. (se implementato: \hyperref[FBR:04.1]{FBR-04.1})
        \end{enumerate}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FBR:05]{FBR-05}, \hyperref[FBR:05.1]{FBR-05.1}, \hyperref[FIR:01.2]{FIR-01.2}, \hyperref[FIR:01.2.1]{FIR-01.2.1}, \hyperref[FIR:01.2.2]{FIR-01.2.2}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
            \item Il bibliotecario clicca sulla barra di ricerca.
            \item Il bibliotecario inserisce la stringa di ricerca (Titolo, Autore, Anno o \hyperref[subsubsec:terminology]{ISBN}).
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FUR:01]{FUR-01}, \hyperref[FDR:02]{FDR-02}, \hyperref[FIR:01.3.3]{FIR-01.3.3}, \hyperref[FIR:07]{FIR-07}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FUR:02]{FUR-02}, \hyperref[FDR:02]{FDR-02}, \hyperref[FIR:01.3.2]{FIR-01.3.2}, \hyperref[FIR:01.3.3]{FIR-01.3.3}, \hyperref[FIR:06]{FIR-06}, \hyperref[FIR:07]{FIR-07}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FUR:03]{FUR-03}, \hyperref[FIR:01.3.2]{FIR-01.3.2}, \hyperref[FIR:01.3.3]{FIR-01.3.3}, \hyperref[FIR:06]{FIR-06}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FUR:04]{FUR-04}, \hyperref[FUR:04.1]{FUR-04.1}, \hyperref[FIR:01.3]{FIR-01.3}, \hyperref[FIR:01.3.2]{FIR-01.3.2}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Postcondizioni}: Vengono mostrati i risultati corrispondenti.
        \item \textbf{Requisiti Implementati}: \hyperref[FUR:05]{FUR-05}, \hyperref[FUR:05.1]{FUR-05.1}, \hyperref[FIR:01.3]{FIR-01.3}, \hyperref[FIR:01.3.1]{FIR-01.3.1}, \hyperref[FIR:01.3.2]{FIR-01.3.2}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
            \item Il bibliotecario clicca sulla barra di ricerca.
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:01]{FLR-01}, \hyperref[FDR:03]{FDR-03}, \hyperref[FIR:01.2.2]{FIR-01.2.2}, \hyperref[FIR:01.2.3]{FIR-01.2.3}, \hyperref[FIR:01.3.2]{FIR-01.3.2}, \hyperref[FIR:01.3.3]{FIR-01.3.3}, \hyperref[FIR:03]{FIR-03}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:02]{FLR-02}, \hyperref[FDR:03]{FDR-03}, \hyperref[FIR:01.1.2]{FIR-01.1.2}, \hyperref[FIR:01.1.3]{FIR-01.1.3}, \hyperref[FIR:02]{FIR-02}, \hyperref[FIR:03]{FIR-03}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:03]{FLR-03}, \hyperref[FIR:01.1.2]{FIR-01.1.2}, \hyperref[FIR:01.1.3]{FIR-01.1.3}, \hyperref[FIR:02]{FIR-02}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:04]{FLR-04}, \hyperref[FLR:04.1]{FLR-04.1}, \hyperref[FIR:01.1]{FIR-01.1}, \hyperref[FIR:01.1.2]{FIR-01.1.2}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Postcondizioni}: Vengono mostrati i risultati corrispondenti.
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:05]{FLR-05}, \hyperref[FLR:05.1]{FLR-05.1}, \hyperref[FIR:01.1]{FIR-01.1}, \hyperref[FIR:01.1.1]{FIR-01.1.1}, \hyperref[FIR:01.1.2]{FIR-01.1.2}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
            \item Il bibliotecario clicca sulla barra di ricerca.
            \item Il bibliotecario inserisce la stringa di ricerca (Data di restituzione, Titolo/Autori/\hyperref[subsubsec:terminology]{ISBN} del libro e/o Nome/Cognome/ID utente).
    ...
    \begin{itemize}
        ...
        \item \textbf{Requisiti Implementati}: \hyperref[FLR:06]{FLR-06}, \hyperref[FDR:02]{FDR-02}, \hyperref[FDR:03]{FDR-03}, \hyperref[FIR:01.1.2]{FIR-01.1.2}, \hyperref[FIR:01.1.3]{FIR-01.1.3}, \hyperref[NUR:01]{NUR-01}
        \item \textbf{Scenario Principale}:
        \begin{enumerate}
