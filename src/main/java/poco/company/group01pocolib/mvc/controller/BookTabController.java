...
public class BookTabController {
    ...
    @FXML private GridPane bookSearchGridPane;
    ...
    private void initialize() {
        ...
        column0Constraints = bookSearchGridPane.getColumnConstraints().get(0);
        column2Constraints = bookSearchGridPane.getColumnConstraints().get(2);
        Platform.runLater(() -> {
    ...
    private void initializeBookColumns() {
        ...
        bookAvailableColumn.setCellValueFactory(cellData -> new ReadOnlyObjectWrapper<>(cellData.getValue().getCopiesAvailable()));
